    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('st_status', models.IntegerField(choices=[(0, '草稿'), (1, '已审批')], default=0, verbose_name='转库单状态')),
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='org_st', to='base.Organization', verbose_name='组织')),
            ],
            options={
                'verbose_name': '转库单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('str_status', models.IntegerField(choices=[(0, '草稿'), (1, '已审批')], default=0, verbose_name='转库申请单状态')),
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='org_str', to='base.Organization', verbose_name='组织')),
            ],
            options={
                'verbose_name': '转库申请单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('str_identify', models.CharField(max_length=15, null=True, verbose_name='转库申请单编号')),
