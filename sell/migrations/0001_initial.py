    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='org_so', to='base.Organization', verbose_name='组织')),
            ],
            options={
                'verbose_name': '销售订单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sell_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='so_sod', to='sell.SellOrder', verbose_name='销售订单')),
            ],
            options={
                'verbose_name': '销售订单明细',
