...
class BuyInStore(models.Model):
    ...
    organization = models.ForeignKey('base.Organization', verbose_name='组织', related_name='org_bis', on_delete=models.CASCADE)
    totalwarehouse = models.ForeignKey('base.TotalWareHouse', verbose_name='仓库', related_name='total_wh_bis', on_delete=models.CASCADE)
    supplier = models.ForeignKey('base.Supplier', verbose_name='供应商', related_name='supplier_bis', on_delete=models.CASCADE)
...
class BisDetail(models.Model):
    ...
    material = models.ForeignKey('base.Material', verbose_name='物料', related_name='material_bd', on_delete=models.CASCADE)
