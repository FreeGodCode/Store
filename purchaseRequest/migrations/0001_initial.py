    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pr_closer_identify', models.CharField(max_length=20, null=True, verbose_name='请购关闭者工号')),
                ('pr_closed_at', models.DateTimeField(auto_now_add=True, null=True, verbose_name='请购关闭时间')),
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='org_pr', to='base.Organization', verbose_name='组织')),
            ],
            options={
                'verbose_name': '请购单',
                'verbose_name_plural': '请购单',
                'db_table': 'db_pr',
            },
        ),
        migrations.CreateModel(
