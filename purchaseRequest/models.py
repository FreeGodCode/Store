...
class PurchaseRequest(models.Model):
    ...
    pr_creator_identify = models.CharField(max_length=20, verbose_name="请购单创建者工号")
    pr_created_at = models.DateTimeField(auto_now_add=True, verbose_name='请购创建时间')
    pr_closer = models.CharField(max_length=20, verbose_name='请购关闭者', null=True)
    pr_closer_identify = models.CharField(max_length=20, verbose_name='请购关闭者工号', null=True)
    pr_closed_at = models.DateTimeField(auto_now_add=True, verbose_name='请购关闭时间', null=True)
