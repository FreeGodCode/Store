...
class PurchaseOrder(models.Model):
    ...
    purchase_request = models.ForeignKey('PurchaseRequest', verbose_name='请购单', related_name='pr_po', on_delete=models.Model)
...
class OrderDetail(models.Model):
    ...
    pr_detail = models.ForeignKey('PurchaseDetail', verbose_name='请购单物料明细', related_name='pr_od', on_delete=models.CASCADE)
