...
class Organization(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    org_iden = models.CharField(max_length=6, unique=True, verbose_name='组织编码')
    ...
    org_creator_iden = models.CharField(max_length=20, verbose_name='组织创建者工号')
...
#     organization = models.ForeignKey('Organization', related_name='orga_center_ware_house', verbose_name='组织', on_delete=models.CASCADE)
...
class Measure(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    measure_iden = models.CharField(max_length=6, unique=True, verbose_name='计量单位编码')
    ...
    measure_creator_iden = models.CharField(max_length=20, verbose_name='计量单位创建者工号')
